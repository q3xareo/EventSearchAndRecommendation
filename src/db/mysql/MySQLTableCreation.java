...
public class MySQLTableCreation {
	...
	public static void main(String[] args) {
		try {
			...
			//IMPORTANT!!!! drop category and history first: they have foreign key
			...
			// use combined columns as primary key, connect foreign key
			...
			//String use "", if float just value (no need "")
